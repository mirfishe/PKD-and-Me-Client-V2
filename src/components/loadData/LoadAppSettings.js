...
function LoadAppSettings() {
  ...
  // * Loads the settings from environment.js first and then if there are any settings in the AppSettings.json file on the server, those override what was set in environment.js. -- 03/06/2021 MF
  ...
  useEffect(() => {
    ...
    // * Only load the AppSettings data once per session unless the data is changed. -- 03/06/2021 MF
