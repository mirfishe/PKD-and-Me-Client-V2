...
const Login = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      {appAllowUserInteractions === true && IsEmpty(sessionToken) === true ? <span className="ps-3"><Button outline className="my-2" size="sm" color="info" onClick={(event) => { setModal(!modal); }}>Login</Button></span> : null}
